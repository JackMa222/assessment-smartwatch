...
function disableAutomatic() {
    disabled = 1;
    cssBackground(z, "right center");
    cssTransition(z, "0s linear");
    cssTransition("dps1", "all 0.3s ease-in-out");
    cssTransition("dps2", "all 0.3s ease-in-out");
    cssTransition("dps3", "all 0.3s ease-in-out");
}
